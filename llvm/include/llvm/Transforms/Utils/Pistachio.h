//===-- Pistachio.h - Based on example file Hello.h ------------------*- C++
//-*-===//
//
...
#ifndef LLVM_TRANSFORMS_UTILS_PISTACHIO_H
#define LLVM_TRANSFORMS_UTILS_PISTACHIO_H
...
class PistachioPass : public PassInfoMixin<PistachioPass> {
...
#endif // LLVM_TRANSFORMS_UTILS_PISTACHIO_H