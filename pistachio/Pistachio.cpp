//===---- Pistachio.cpp - Based on example pass Hello.cpp -----------------===//
...
#include "llvm/Transforms/Utils/Pistachio.h"
...
PreservedAnalyses PistachioPass::run(Function &F, FunctionAnalysisManager &AM) {
  ...
  // state function name and results
...
bool PistachioPass::checkAgainstAllLoads(AAResults &aa, Instruction &store) {
  bool result = false;
...
void PistachioPass::addStore(Instruction *s) {
...
void PistachioPass::recordLoad(Instruction *s, Instruction *l,
...
void PistachioPass::printStoreLoadInfo() {
...
void PistachioPass::printAliasInfo(AliasInfo info) {
