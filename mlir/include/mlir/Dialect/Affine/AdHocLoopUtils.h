//===- AdHocLoopUtils.h - Loop transformation used by the Ad-Hoc Loop Tile Pass --------------*- C++ -*-===//
//
...
LogicalResult HOODLEloopUnrollFull(AffineForOp forOp); // just to have something defined in this header.
