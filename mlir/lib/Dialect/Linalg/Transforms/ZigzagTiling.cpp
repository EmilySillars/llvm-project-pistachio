...
mlir::linalg::zigzag::applyTileAndFuseToAll(RewriterBase &rewriter, Operation *transformOp,
...
/// tiled operation as well as the created tile loops.
LogicalResult
static mlir::linalg::zigzag::applyTileAndFuseToEachRoot(RewriterBase &rewriter,
